...
class WorkflowState(BaseModel):
    ...
    # TMF 645 Service Qualification fields
    tmf645_request: Optional[dict] = Field(None, description="TMF 645 service qualification request")
    validation_result: Optional[dict] = Field(None, description="Validation result from validator agent")
    qualification_result: Optional[dict] = Field(None, description="Qualification result from qualifier agent")
    validation_passed: Optional[bool] = Field(None, description="Whether TMF 645 validation passed")
    service_qualified: Optional[bool] = Field(None, description="Whether service is qualified")
