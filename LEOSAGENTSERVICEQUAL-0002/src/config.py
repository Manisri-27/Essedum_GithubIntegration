...
class AppConfig(BaseSettings):
    ...
    # vLLM configuration
    vllm_url: str = Field("http://192.168.28.36:30858/v1/completions", alias="VLLM_URL")
    vllm_model_name: str = Field("/root/.cache/huggingface/Llama-3.2-3B-Instruct", alias="VLLM_MODEL_NAME")
